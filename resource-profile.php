...
$fetch_query= "SELECT * from `resources` where id = '$resourceid' ";
...
if(isset($_REQUEST["submit"]))
{
    ...
    $qry = "UPDATE `resources` SET `shortlist_status`='$shortlist_status',`project_assigned`='$project_assign' WHERE id = '$id';
    ";
                ...
                <div class="profile-card">
                    ...
                    <div class="profile_body">
                        ...
                        <span>Current Company :</span>
                           <p class="data"> <?php echo $data["current_company"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Current Salary :</span>
                           <p class="data"> <?php echo $data["current_ctc"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Notice Period :</span>
                           <p class="data"> <?php echo $data["notice_period"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Freelancer :</span>
                           <p class="data"> <?php echo $data["freelance_ready"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Rate P/H :</span>
                           <p class="data"> <?php echo $data["rate_per_hour"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Resume :</span>
                        ...
                        <span>Relevant Experience :</span>
                           <p class="data"> <?php echo $data["relevant_exp"]; ?></p>
                        </div>
                        <div class="profile_data">
                        ...
                        <span>Current Role :</span>
                           <p class="data"> <?php echo $data["current_role"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Expected Salary :</span>
                           <p class="data"> <?php echo $data["expected_ctc"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Type of job :</span>
                           <p class="data"> <?php echo $data["job_type"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Device Available :</span>
                           <p class="data"> <?php echo $data["device_available"]; ?></p>
                        </div>
                        <div class="profile_data">
                        <span>Linkedin :</span>
                           <p class="data"> <a href="<?php echo $data["linkedin"]; ?>" target="_blank" >Click to Visit</a></p>
                        </div>
                ...
                <form action="" method="post" enctype="multipart/form-data" >
                    <div class="profile-buttonwrapper">
                        ...
                        <div class="button-data">
                            ...
                            <span class="">
                                <input type="text" class="profile-input" name="project_assign" value="<?php echo $data['project_assigned']; ?>"> 
